...
},{"./parent.js":2,"lodash":3}],2:[function(require,module,exports){
...
},{"./binding":5,"./config":7,"./deps-parser":8,"./directive":9,"./emitter":20,"./exp-parser":21,"./observer":24,"./text-parser":25,"./utils":27,"./viewmodel":28}],7:[function(require,module,exports){
...
},{"./emitter":20,"./observer":24,"./utils":27}],9:[function(require,module,exports){
var dirId           = 1,
    ARG_RE          = /^[\w\$-]+$/,
    FILTER_TOKEN_RE = /[^\s'"]+|'[^']+'|"[^"]+"/g,
...
},{"../config":7,"../transition":26,"../utils":27,"./html":10,"./if":11,"./model":13,"./on":14,"./partial":15,"./repeat":16,"./style":17,"./view":18,"./with":19}],13:[function(require,module,exports){
var utils = require('../utils'),
...
},{"../config":7,"../utils":27}],17:[function(require,module,exports){
var camelRE = /-([a-z])/g,
...
},{"./config":7,"./directives":12,"./filters":22,"./observer":24,"./transition":26,"./utils":27,"./viewmodel":28}],24:[function(require,module,exports){
/* jshint proto:true */
...
},{"./emitter":20,"./utils":27}],25:[function(require,module,exports){
var openChar        = '{',
    endChar         = '}',
    ESCAPE_RE       = /[-.*+?^${}()|[\]\/\\]/g,
...
},{"./directive":9}],26:[function(require,module,exports){
...
},{"./batcher":4,"./config":7}],27:[function(require,module,exports){
var config    = require('./config'),
    toString  = ({}).toString,
    win       = window,
    console   = win.console,
...
},{"./config":7,"./viewmodel":28}],28:[function(require,module,exports){
...
module.exports = ViewModel
},{"./batcher":4,"./compiler":6,"./transition":26,"./utils":27}],29:[function(require,module,exports){
/* global describe, it */
    ...
    describe('one', function () {
        describe('message', function () {
            it('should return "This is one"', function () {
                ...
                expects(one.computed.msg()).to.equal('This is one');
            });
        });
    });
})();

},{"../../app/scripts/one.js":1,"vue":23}],30:[function(require,module,exports){
/* global describe, it */
